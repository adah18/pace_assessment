<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="quizcreation_update.aspx.cs" Inherits="PAOnlineAssessment.assessment.quizcreation_update" %>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList 
                                ...
                                CssClass="GridPagerButtons" Width="200px"
                                onselectedindexchanged="ddlQuarter_SelectedIndexChanged" Visible="True" Enabled="false">
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td ><span class="FieldTitle" lang="en-ph"><asp:Label ID="lblCaptionTimeFrom" runat="server" Text="From:"></asp:Label></span> &nbsp&nbsp<asp:DropDownList 
                            ...
                            </asp:DropDownList>&nbsp&nbsp<asp:DropDownList Width="40px" ID="ddlStartMin" runat="server" 
                            ...
                            <asp:DropDownList ID="ddlStartAMPM" Width="40px" runat="server" CssClass="GridPagerButtons">
                            <asp:ListItem>AM</asp:ListItem>
                            <asp:ListItem>PM</asp:ListItem>
                            </asp:DropDownList>&nbsp&nbsp 
                            <span class="FieldTitle" lang="en-ph"><asp:Label ID="lblCaptionTimeTo" Width="40px" runat="server" Text="To:"></asp:Label></span>&nbsp<asp:DropDownList 
                            ...
                            <asp:ListItem>11</asp:ListItem>
                            <asp:ListItem>12</asp:ListItem>
                            </asp:DropDownList>&nbsp&nbsp<asp:DropDownList ID="ddlEndMin" Width="40px" runat="server" 
                                CssClass="GridPagerButtons">
                            <asp:ListItem>00</asp:ListItem>
                            <asp:ListItem>01</asp:ListItem>
                            <asp:ListItem>02</asp:ListItem>
                            ...
                            <asp:DropDownList ID="ddlEndAMPM" runat="server" Width="40px" CssClass="GridPagerButtons">
                            <asp:ListItem>AM</asp:ListItem>
                            <asp:ListItem>PM</asp:ListItem>
                            </asp:DropDownList>
                            </td>                
                            ...
                            <asp:GridView ID="dgQuestionBank" runat="server" AllowPaging="True" EmptyDataRowStyle-ForeColor="ActiveBorder" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Questions">
                                        <ItemTemplate>
                                            <asp:Label ID="lblQuestions" runat="server" CssClass="LabelClass" Text='<%# Eval("Question") %>' Style="display:inline" Width="100%"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle BackColor="#3F5330" BorderColor="Black" BorderStyle="Solid" 
                                ...
                                <PagerTemplate>
                                    <div>
                                            ...
                                            &nbsp;<asp:DropDownList ID="cboPageNumber_DB" runat="server" AutoPostBack="True" 
                                                CssClass="GridPagerButtons" ToolTip="Jump to Page"  Width="40px"
