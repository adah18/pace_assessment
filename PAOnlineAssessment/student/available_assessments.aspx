<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="available_assessments.aspx.cs" Inherits="PAOnlineAssessment.student.available_assessments" %>
...
<head runat="server">
    <title>Available Assessment - Pace Academy Online Assessment System</title>
    ...
    <div id="bodytopmainPan">
        <div id="bodytopPan">
            <table style="width:100%;">
                <tr>
                    <td>
                        <span class="PageHeader" lang="en-ph">Available Assessments</span></td>
                    <td>
                        &nbsp;</td>
                    <td>
                        &nbsp;</td>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <table style="width:100%;">
                                    ...
                                    <tr>
                                        <td>
                                            <span class="PageSubHeader" lang="en-ph">List of Assessments Ready to be Taken</span></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            &nbsp;</td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:GridView ID="grdAvailableAssessments" runat="server" AllowPaging="True" 
                                                ...
                                                onrowdatabound="grdAvailableAssessments_RowDataBound" PageSize="20" 
                                                                    ...
                                                                    <td class="style1" rowspan="4" style="width: 120px;">
                                                                        <center>
                                                                            <asp:ImageButton ID="imgTakeAssessment" runat="server" 
                                                                                ...
                                                                                ImageUrl="~/images/dashboard_icons/pencil_page.png" ToolTip="Take Assessment" 
                                                                                Width="64px"
                                                                                 />
                                                                            <br />
