    ...
    public partial class assessment_evaluation : System.Web.UI.Page
    {
        ...
        void loadAssessmentEvaluation()
        {
            ...
            oStudentListRegistration.ForEach(slr =>
                {
                    if (slr.SchoolYear == Session["CurrentSchoolYear"].ToString() && slr.SectionID.ToString() == cboSection.SelectedValue && slr.LevelID.ToString() == cboGradeLevel.SelectedValue)
                    {
        ...
        void loadAssessment()
        {
            ...
            {
                //load assessment by quarter, school year
        ...
        void loadSections()
        {
            ...
            oGradingView.ForEach(gv =>
            {
                if (gv.TeacherID.ToString() == cboTeacher.SelectedValue && gv.SchoolYear == Session["CurrentSchoolYear"].ToString())
                {
                    ...
                    {
                        if (gv.SchoolYear == s.SchoolYear && s.LevelID == Convert.ToInt32(cboGradeLevel.SelectedValue) && gv.SectionID == s.SectionID)
                        {
