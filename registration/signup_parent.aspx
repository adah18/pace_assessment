<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signup_parent.aspx.cs" Inherits="PAOnlineAssessment.registration.signup_parent" %>
                        ...
                        <table>
                                <tr>
                                    <td>
                                        ...
                                        <br />
                                        <asp:LinkButton ID="btnAdd" runat="server" onclick="btnAdd_Click">Add New Row</asp:LinkButton>
                                    </td>
                                </tr>
                                <tr>
                                   <td class="LoginSubNote">
                        <asp:GridView ID="gvChildInfo" runat="server" AutoGenerateColumns="False" 
                            onrowdatabound="gvChildInfo_RowDataBound" PageSize="1">
                            <Columns>
                                <asp:TemplateField HeaderText="No.">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="imgAction" runat="server" 
                                            ImageUrl="~/images/icons/page_tick.gif" Visible="false" />
                                ...
                                <asp:TemplateField HeaderText="Firstname">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtFirstname1" runat="server" RowCount='<%# Eval("Count") %>' 
                                            Text='<%# Eval("Firstname") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Lastname">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtLastname1" runat="server" RowCount='<%# Eval("Count") %>' 
                                            Text='<%# Eval("Lastname") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Level">
                                    <ItemTemplate>
                                        <asp:DropDownList ID="cboLevel1" runat="server" AutoPostBack="false"
                                            RowCount='<%# Eval("Count") %>' Width="150px">
                                        </asp:DropDownList>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnRemove" runat="server" onclick="btnRemove_Click" 
                                            RowCount='<%# Eval("Count") %>'>Remove</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" Visible="false">
                            <ContentTemplate>
                                <table style="width:100%;">
                                    ...
                                    <tr>
                                        <td>
                                            <cc1:CaptchaControl ID="upCaptcha" runat="server" Width="176px" 
                                                CacheStrategy="Session" Arithmetic="False" CaptchaLength="4" 
                                                CaptchaMaxTimeout="240" CaptchaMinTimeout="5" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
