<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_dashboard.aspx.cs" Inherits="PAOnlineAssessment.system.admin_dashboard" %>
...
<head runat="server">
    <title>Administrators' Dashboard - Pace Academy Online Assessment System</title>
        ...
        <div id="bodytopPan">
        	<p>
                <table style="width:100%;" cellpadding="10">
                    ...
                    <tr>
                        <td colspan="3">
                            <span class="PageSubHeader" lang="en-ph">Tools</span></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            &nbsp;</td>
                    ...
                    <tr>
                        ...
                        <%--<td><center>
                            <asp:ImageButton ID="imgSystemSettings" runat="server" 
                                ImageUrl="~/images/dashboard_icons/process.png" Height="128px" 
                                ImageAlign="Middle" Width="128px" CssClass="LargeButtonTemplate" 
                                onclientclick="return false;" /><br />
                            <span lang="en-ph" class="LinkButtonTemplate">System<br />Settings</span></center>
                        </td>--%>
                        <td><center>
