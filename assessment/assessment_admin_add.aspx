<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="assessment_admin_add.aspx.cs" Inherits="PAOnlineAssessment.assessment.assessment_add" %>
...
<body>
    ...
    <div id="bodytopmainPan">
        ...
        <h2 style="background-color: #FFFFFF">
            <span class="PageHeader" lang="en-ph">Create Assessment</span>
        </h2>
        <center>
         <table >
        <tr>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table style="width:100%;">
                    ...
                    <tr>
                        <td align="right" >
                            <span class="FieldTitle" lang="en-ph"></span>&nbsp
                            <span class="FieldTitle" lang="en-ph">
        ...
        <tr><td>&nbsp;</td></tr>
        <tr><td>
            <span lang="en-ph" class="ValidationNotice">Fields marked with an (*) are required.an (*) are required.</span></td></tr>
            <tr><td>&nbsp;</td></tr>
        <tr>
