<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="assessment_admin_update.aspx.cs" Inherits="PAOnlineAssessment.assessment.assessment_admin_update" %>
...
<head runat="server">
    ...
    <script src="datepicker/src/js/jscal2.js" type="text/javascript"></script> 
    <script src="datepicker/src/js/lang/en.js" type="text/javascript"></script> 
...
<body>
    ...
    <div id="bodytopmainPan">
        <div id="bodytopPan">
        <h2 style="background-color: #FFFFFF"><span class="PageHeader" lang="en-ph">Edit Assessment</span></h2>
        ...
        <tr>
            <td align="left" valign="top" ><span class="FieldTitle" lang="en-ph">Teacher:</span></td>
            <td>
                <asp:DropDownList ID="ddlTeacher" runat="server" CssClass="GridPagerButtons" 
                    Width="200px" AutoPostBack="True" 
                    onselectedindexchanged="ddlTeacher_SelectedIndexChanged1">
                </asp:DropDownList>
                <asp:Label ID="lblTeacher"
                    runat="server" Text="*" ForeColor="Red"></asp:Label>
                <br />
                <span class="LoginSubNote" lang="en-ph">Select a teacher you want to create assessment with.</span>
                </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList 
                                ...
                                onselectedindexchanged="ddlQuarter_SelectedIndexChanged" Visible="True" Enabled="false" Width="200px">
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td ><span class="FieldTitle" lang="en-ph"><asp:Label ID="lblCaptionTimeFrom" runat="server" Text="From:"></asp:Label></span> &nbsp&nbsp<asp:DropDownList 
                                ID="ddlStartHour" runat="server" CssClass="GridPagerButtons">
                            ...
                            <asp:DropDownList ID="ddlStartAMPM" runat="server" CssClass="GridPagerButtons">
                            ...
                            <span class="FieldTitle" lang="en-ph"><asp:Label ID="lblCaptionTimeTo" runat="server" Text="To:"></asp:Label></span>&nbsp<asp:DropDownList 
                                ID="ddlEndHour" runat="server" CssClass="GridPagerButtons">
                            <asp:ListItem>01</asp:ListItem>
                            <asp:ListItem>02</asp:ListItem>
                            <asp:ListItem>03</asp:ListItem>
                            <asp:ListItem>04</asp:ListItem>
                            ...
                            <asp:DropDownList ID="ddlEndAMPM" runat="server" CssClass="GridPagerButtons">
                            <asp:ListItem>AM</asp:ListItem>
                            <asp:ListItem>PM</asp:ListItem>
                            </asp:DropDownList>
                            </td>                
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table style="width:100%;">
                    <tr>
                        <td align="left" >
                            <span class="PageSubHeader" lang="en-ph">Questions Details</span>
                    ...
                    <tr>
                        <td ><span class="PageSubHeader" lang="en-ph">Available Questions:</span></td>
                    ...
                    <tr>
                            ...
                            <asp:GridView ID="dgQuestionBank" runat="server" AllowPaging="True" EmptyDataRowStyle-ForeColor="ActiveBorder" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Questions">
                                        <ItemTemplate>
                                            <asp:Label ID="lblQuestions" runat="server" CssClass="LabelClass" Style="display:inline" Text='<%# Eval("Question") %>' Width="100%"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle BackColor="#3F5330" BorderColor="Black" BorderStyle="Solid" 
                                ...
                                <PagerTemplate>
                                    <div>
                                            ...
                                            &nbsp;<asp:DropDownList ID="cboPageNumber_DB" runat="server" AutoPostBack="True" 
                                                ...
                                                onselectedindexchanged="cboPageNumber_DB_SelectedIndexChanged">
                                            </asp:DropDownList>
                        ...
                        <tr>
                            <td><span class="PageSubHeader" lang="en-ph">Selected Questions:</span></td>
                        </tr>
                        ...
                        <td align="justify" valign="top" >
                            <asp:GridView ID="dgQuestions" runat="server" AllowPaging="True" EmptyDataRowStyle-ForeColor="ActiveBorder" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Questions">
                                        <ItemTemplate>
                                            <asp:Label ID="lblQuestions" runat="server" Text='<%# Eval("Questions") %>' Style="display:inline" Width="100%"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle BackColor="#3F5330" BorderColor="Black" BorderStyle="Solid" 
